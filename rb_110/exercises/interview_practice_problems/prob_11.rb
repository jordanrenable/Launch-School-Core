...
PROBLEM
input- string
output- 2 element array, first element is a substring, and the second element is an integer
  - the relationship of these elements are that element 1 * element 2 equals input string
